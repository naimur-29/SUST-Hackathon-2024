...
const Card = ({ data }) => {
  ...
  return (
    <div className="cardContainer w-[95%] xsm:w-[85%] sm:w-[100%] m-auto sm:m-0 ">
      <div className="cardWrapper min-h-[17rem] bg-gray-200 py-6 px-3 rounded shadow-lg  ">
        {/* card top icon starts  */}
        <div className="cardTop  mb-3 sm:mb-5  flex justify-center items-center text-3xl sm:text-4xl ">
          {icon}
        </div>
        {/* card top icon ends  */}

        {/* card middle heading  starts  */}
        <div className="cardMiddle  text-xl xsm:text-2xl mb-4 sm:mb-6 ">
